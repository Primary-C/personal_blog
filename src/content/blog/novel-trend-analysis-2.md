...
여기서 적용한 규칙이 **"50편 컷오프"**입니다. 웹소설 시장에는 "50편 안에 못 뜨면 끝이다"라는 암묵적인 생존 법칙이 있습니다. 독자들은 보통 초반 5편에서 10편 안에 작품을 계속 볼지 결정하고, 그 장벽을 넘긴 작품이 입소문을 타며 차트에 올라오기까지 대략 30편에서 50편 정도의 구간이 걸립니다. 다시 말해, 50편 이하의 작품이 베스트에 들어와 있다는 건 **지금 이 순간 실시간으로 트렌드를 만들어가고 있는 작품**이라는 뜻이고, 50편을 돌파하고도 차트에 남아있다면 이미 검증이 끝난 기성작으로 봐도 무방합니다.
